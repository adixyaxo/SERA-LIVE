...
const Index = () => {
  ...
  }, [user, navigate, loadUserCards]);

  // ✨ Handle QuickCapture New Cards
  ...
  // ⚡ Handle Actions (accept, reject, done, etc.)
        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="animate-fade-in glass p-6 rounded-3xl">
            ...
            <p className="text-muted-foreground text-sm sm:text-base">
              Here's your intelligent routine overview
            </p>
          </div>
                  ...
                  <>
                    <ScheduleCard
                      card={{
                        ...
                        description:
                          "Traffic detected on your route. Adjusting commute buffer by 30 minutes.",
                        primary_action: {
                    ...
                    <ScheduleCard
                      card={{
                        ...
                        description:
                          "Energy levels typically drop at this time. Consider a 15-minute break.",
                        primary_action: {
                          event_title: "Break",
                          start_time: new Date().toISOString(),
                          end_time: new Date(
